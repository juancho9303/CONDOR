...
path = home + "/Dropbox/PhD/paper_2/scripts/clumps_scripts/"
...
clumps = pd.read_csv(f'{path}/../../Data/clump_thresolds.csv',encoding='ISO-8859-1')
...
def individual(i, j, results, x0_phot, y0_phot, r_d, pixscale, resolution_ratio, kpc_per_pix, sigma_ns, sigma_ao,
    ...
    clump_number = clumps.number_clumps[i]
    ...
    print(colored("j analitic  / clumps =", "blue"), "%.2f / %d" % (j_model, clump_number))
